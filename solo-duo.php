...
<div class="container" style="font-size:14px; color: #FFF; margin-top: 100px;">
    <div class="row">
        <div class="col-8">
            ...
            <div style="width: 100%; height: 150px; border-radius: 15px; background-color: #1e2023; box-shadow: 0px 5px 10px 0px rgba(0, 0, 1, 0.63);">
                <div class="row pt-4">
                    <div class="col-4" style="height: 100px;" id="current-rank-img-container">
                    ...
                    <div class="col-4 new-select-div pr-0 align-self-center">
                        <label for="current-tier-solo" style="color:#fff">Current Tier</label>
                    ...
                    <div class="col-4 new-select-div pr-0 align-self-center">
                        <label for="current-division-solo" style="color:#fff">Current Division</label>
    ...
    <div class="row">
        <div class="col-8">
            ...
            <h4 style="text-align:center">SELECT YOUR <span style="color: #db1761">NUMBER OF WINS</span></h4>
